---
title: FixIt Lab
description: Upgrade to R34 from R32
order: 6
---

## Introduction

In this lab, we will be going through a scenario where you will need to upgrade NGINX Plus R32 to R34. Upgrading to R34
will introduce a breaking change.

The goal of this section will be to
- Become familiar with the upgrade process to R34 from an older NGINX Plus version.

## FixIt Lab

Let's now go through this scenario where you will upgrade a previous R32 release to R34.

1. Open up a **Web Shell** to the **NGINX Plus R32 (FixIt)** instance in UDF.

1. Run the following command to upgrade to R34.
    ```shell
    apt update
...
1. You will note the following output indicating **nginx-plus** wasn't upgraded.
    ...
    NGINX Plus R34 introduces a breaking change.
...
2024/11/08 18:35:11 [notice] 19815#19815: nginx/1.27.2 (nginx-plus-r34)
...
If you've upgraded to R34 but **nginx* isn't able to reload because of an unknown directive that is new starting on R34,
...
1. Update to the R34 release.

## Conclusion

Thank you for your time on this upskill session for NGINX Plus R34.

## Feedback

Do you have feedback? Please create a [new issue](https://github.com/f5devcentral/nginx-plus-r34-upskill/issues).
