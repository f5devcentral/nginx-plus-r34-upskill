...
Why is NIM being used in this scenario? Remember NGINX Plus R34 will require usage reports being sent to an F5 SaaS or
...
1. We will save your NGINX R34 JWT as an environment variable for ease. This will be used as your auth token when making
...
1. From UDF, open up a **Web Shell** for your **NGINX Plus R34 (Part 2)** instance.
...
- NGINX Plus R34 is installed and is submitting usage reports to NIM.
...
a FixIt lab. [Click here](r34-6.mdx) to proceed to that.
