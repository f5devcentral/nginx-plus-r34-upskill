...
Remember there are two areas introduced in NGINX Plus R34:
...
[Demo: NGINX R34 Instance with Internet Connectivity](https://f5u.csod.com/ui/lms-learning-details/app/video/77086780-e0ce-4907-8fbb-43cb51d1836c)

> You must be logged into [LearnF5](https://f5u.csod.com/) to access it.

### NGINX Plus R34 on cloud
...
### NGINX Plus R34 in container

There are available environment variables relating to E&V when running NGINX Plus R34 as a container listed below.
...
An example of running NGINX Plus R34 in docker is below.
...
docker run -v $(PWD)/my-nginx-plus.jwt:/etc/nginx/license.jwt \
  ...
  private-registry.nginx.com/nginx-plus/base:nginx-plus-r34-debian-bookworm
```
...
[Click here](r34-4.mdx) to proceed to that.
