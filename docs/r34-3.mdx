...
Blog post: <https://blog.nginx.org/blog/optimizing-resource-usage-for-complex-ssl-configurations>.
=======
...
1. **Rename Certificate:**
   ...
   ```bash
   sudo mv /etc/nginx/ssl/lab.sslcaching.f5npi.net.pem /etc/nginx/ssl/lab.sslcaching.f5npi.net.bak
   ```
